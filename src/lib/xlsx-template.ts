...
export function downloadTemplateBimbingan(records: MahasiswaRecord[]) {
  ...
  const petunjuk = XLSX.utils.aoa_to_sheet([
    ...
    ['sks_krs', 'angka 0–200. SKS KRS semester yang tertulis pada laporan (semester yang akan dijalani).'],
    ['ip_khs', 'angka 0.00–4.00. IP semester yang BARU SELESAI — satu tingkat di bawah nomor semester pada laporan (mis. semester tertulis 9 → isi IP semester 8).'],
